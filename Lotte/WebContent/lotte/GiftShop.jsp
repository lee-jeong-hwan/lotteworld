...
<%
	GiftshopDao gDao = new GiftshopDao();
	ArrayList<GiftshopDto> list = gDao.giftshopMain();
	int cnt = gDao.giftshopCnt();
%>
...
<head>
	...
	<style>
		...
		* {
		...
		.top {
		    height: 480px;
		    background: url(https://adventure.lotteworld.com/common/images/icon/enjoy_bg4.jpg) no-repeat 50% 0;
		}
		.topsub {
		    position: relative;
		    max-width: 1170px;
	...
	var search = 0;
			...
			$.ajax({
				...
				success: function(d) {
					for(var i = 0; i < d.length; i++){
						...
						var image2 = d[i].image2;
						var str = 
							"<a href = 'LotteController?command=detailGiftshop&name="+name+"'>"
							+"<div class='sub'>"
							+"<img src='images1/"+image2+"'>"
							+"<span class='label'>"+location+"</span>"
							+"</div>"
							+"<div class='name' style='width: 193px;'><strong>"+name+"</strong></div>"
							+"</a>"
						$(".bottom").append(str);
					}
				pagenum++;
		...
		function searchGiftshop() {
			var location = $(".locationbox").text();
			$.ajax({
				type: "get",
				url: "GiftShopActionServlet",
				...
				success: function(d) {
					...
					if(d.length != 0){
						...
						var strNo =
							"<div class='noData'>"
							+"<p class='noDataText'>검색된 기프트샵이 없습니다.</p>"
							+"</div>"
						$(".bottom").append(strNo);
					}
		...
		$(function() {
			...
			$(".bottom > a").click(function() {
				...
				location.href="LotteController?command=detailGiftshop&name="+name;
			});
				...
				<div class="top">
					<div class="topsub">
						<div class="topsubIn">
							...
							<div class="three">
								<a class="third" href="javascript:void(0)" onclick="view3()" style="font-family:NotoSans-Bold">기프트샵</a>
					...
					<h2 class="middle">기프트샵</h2>
					<p class="middlesub">사랑 가득, 추억 듬뿍! 기프트샵에서 귀여운 상품들을 만나보세요.</p>
				</div> <!-- top -->
				<div class="centerbottom">
					...
					<form name="search2" id="search2">
						<div class="center2">
							...
							<div id="openDivButton">
								<div class="1">
									<div class="fl" style="width:170px; height:50px; margin-right:10px;"><button style="cursor: pointer; z-index: 1; position:relative;"class="submit" type="button" onclick="javascript:searchGiftshop()">조회하기</button></div>
									<div class="fl" style="width:50px; height:50px;"><button onclick="window.location.reload()" style="cursor:pointer;" type="button"><img src="https://adventure.lotteworld.com/common/images/btn/srch_reset.png"/></button></div>
									<div style="clear:both;"></div>
								</div>
							</div>
						</div> <!-- center2 -->
					...
					<div class="bottom">
						...
						%>
							<a href = "javascript:void(0)">
								<div class="sub">
									<img src="images1/<%=list.get(i).getImage2()%>">
									<span class="label"><%=list.get(i).getLocation()%></span>
								</div>
								<div class="name" style="width: 193px;"><strong><%=list.get(i).getName()%></strong></div>
							</a>
						<%
							}
						%>
