			...
			alert("아이디를 입력해주세요.");
				...
				$.ajax({
					...
					success : function(data){
						if(data.result==1){
							location.href="LotteController?command=PWcheck";
						}else{
	...
	<div class="container">
		...
		<div class="contents">
				...
				<div class="row">
					...
					<div class="col-md">
						<div class="form-wrap __normal __x1">
							<div class="inner">
								<div class="ui-input">
									<input type="text" id="user-id" title="아이디를 입력해주세요."> <!-- 아이디를 입력해주세요. -->
									<span class="placeholder">아이디를 입력해주세요. </span>
								</div>
								<button class="ui-button __square-small __black" id="checkId" onclick="fnCheckId();">확인</button><!-- 확인 -->
							</div>
						</div>
					</div>
				</div>
			...
			<div class="btn-area __center">
				<button type="button" class="ui-button __square-large __black" onclick="history.back()">취소 </button><!-- 취소 -->
			</div>
		</div>
		<!-- //contents -->
	</div>
